...
public class CglibSubclassingInstantiationStrategy extends SimpleInstantiationStrategy {
	...
	/**
	 * CglibSubclassingInstantiationStrategy 为 Spring 实例化 Bean 的默认实例化策略，
	...
	private static class CglibSubclassCreator {
		...
		// 这里又定义了两个熟悉的拦截器 ：LookupOverrideMethodInterceptor 和 ReplaceOverrideMethodInterceptor，
		// 两个拦截器分别对应两个不同的 callback 业务
