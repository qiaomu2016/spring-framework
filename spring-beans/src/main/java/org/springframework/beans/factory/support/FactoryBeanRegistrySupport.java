...
public abstract class FactoryBeanRegistrySupport extends DefaultSingletonBeanRegistry {
	...
	protected Object getObjectFromFactoryBean(FactoryBean<?> factory, String beanName, boolean shouldPostProcess) {
		...
		// #beforeSingletonCreation(String beanName)  ：用于添加标志，当前 bean 正处于创建中
		// #afterSingletonCreation(String beanName) : 用于移除标记，当前 Bean 不处于创建中
		// #postProcessObjectFromFactoryBean(Object object, String beanName)

		// 为单例模式 且 beanName在缓存singletonObjects中存在
					...
					if (alreadyThere != null) {
						...
						if (shouldPostProcess) {
							...
							try {
								...
								// 生成的对象将暴露给 bean 引用
								// 子类可以重写，例如:AbstractAutowireCapableBeanFactory
